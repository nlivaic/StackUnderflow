        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAcceptedAnswer = table.Column<bool>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(nullable: false),
                    Body = table.Column<string>(nullable: true),
                    IsAcceptedAnswer = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Body = table.Column<string>(nullable: true),
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    ParentQuestionId = table.Column<Guid>(nullable: true),
                    ParentAnswerId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Answers_ParentAnswerId",
                        column: x => x.ParentAnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_Questions_ParentQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ParentAnswerId",
                table: "Comments",
                column: "ParentAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_ParentQuestionId",
                table: "Comments",
